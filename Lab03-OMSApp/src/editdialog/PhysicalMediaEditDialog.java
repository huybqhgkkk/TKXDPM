...
public class PhysicalMediaEditDialog extends MediaEditDialog{
	...
	public void buildControls() {
		...
		if (t instanceof PhysicalMedia) {
			...
			JLabel barcodeLabel = new JLabel("Huy.VQ173170 - Barcode");
			c.gridx = 0;
			c.gridy = row;
			...
			row = getLastRowIndex();
			JLabel descriptionLabel = new JLabel("Huy.VQ173170 - Description");
			c.gridx = 0;
			c.gridy = row;
			...
			row = getLastRowIndex();
			JLabel quantityLabel = new JLabel("Huy.VQ173170 - Quantity");
			c.gridx = 0;
			c.gridy = row;
			...
			row = getLastRowIndex();
			JLabel weightLabel = new JLabel("Huy.VQ173170 - Weight");
			c.gridx = 0;
			c.gridy = row;
			...
			row = getLastRowIndex();
			JLabel dimensionWidthLabel = new JLabel("Huy.VQ173170 - Dimension Width");
			c.gridx = 0;
			c.gridy = row;
			...
			row = getLastRowIndex();
			JLabel dimensionHeightLabel = new JLabel("Huy.VQ173170 - Dimension Height");
			c.gridx = 0;
			c.gridy = row;
			...
			row = getLastRowIndex();
			JLabel dimensionDepthLabel = new JLabel("Huy.VQ173170 - Dimension Depth");
			c.gridx = 0;
			c.gridy = row;
